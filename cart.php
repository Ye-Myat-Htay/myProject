                  ...
                  <form action="" method="post">
                    ...
                    <div class = "d-flex mb-5">
                      ...
                      if($result_count > 0) {
                        ...
                        <button class = 'bg-secondary px-3 border-0 px-3 py-2'><a href='./users_area/checkout.php' class='text-light text-decoration-none'>Checkout</a></button>'";
                      }else {
