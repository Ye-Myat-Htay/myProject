...
<div class="container mt5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="text-center">
            <input type="submit" class="btn btn-info border-0 p-2" name="edit_product" value="Update Product">
        </div>
    </form>
</div>
...
if(isset($_POST['edit_product'])) {
    ...
    if($product_title == '' or $product_keywords == '' or$product_category == '' or $product_price == '' or $product_image1 == '' or $product_image2 == '' or $product_image3 == '' or $product_price == '') {
